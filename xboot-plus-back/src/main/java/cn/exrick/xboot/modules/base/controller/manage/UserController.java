...
public class UserController {
    ...
    public Result<List<User>> searchByName(@PathVariable String username){

        List<User> list = userService.findByUsernameLikeAndStatus("%"+username+"%", CommonConstant.STATUS_NORMAL);
